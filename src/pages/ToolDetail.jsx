...
function ReviewWidget({ tool, onReviewSubmitted }) {
  ...
  const getLabelStyle = (zone) => {
    ...
    return {
      color: active ? c.css : '#374151',
      opacity: active ? 1 : 0.5,
      transition: 'all 0.3s',
      textShadow: active ? `0 0 10px rgba(${c.r},${c.g},${c.b},0.5)` : 'none'
    }
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-10 justify-center">
        ...
        <div>
          <div className="text-white font-bold text-xl">{tool.name}</div>
      ...
      <div className="mb-10">
        <div className="flex justify-between mb-4 px-1">
          <span className="text-xs font-bold font-mono tracking-widest" style={getLabelStyle('weak')}>◈ WEAK</span>
          <span className="text-xs font-bold font-mono tracking-widest" style={getLabelStyle('solid')}>◈ SOLID</span>
          <span className="text-xs font-bold font-mono tracking-widest" style={getLabelStyle('god')}>◈ GOD</span>
        </div>
        <div
          ref={trackRef}
      ...
      <div className="mb-8">
        ...
        <div className="text-[10px] font-mono mb-4" style={{ color: 'rgba(255,255,255,0.2)' }}>
        ...
        <div className="rounded-2xl p-6 mb-8"
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            ...
            <a
              ...
              className="px-6 py-2.5 rounded-xl text-white text-sm font-bold text-center transition-all hover:-translate-y-0.5 hover:shadow-lg whitespace-nowrap"
              style={{
